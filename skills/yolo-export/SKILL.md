...
| Apple iOS 27+/macOS 27+                                  | `coreai`                                                          | new `.aimodel` path; export on Apple silicon with macOS 26+                                               |
...
| `opset`     | auto    | compatible ONNX opset selected automatically; pin lower if the consumer runtime complains                                                                                                       |
